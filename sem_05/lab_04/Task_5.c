...
#include <signal.h>
#define MAX_LEN 1000
#define MESSAGE_1 "4rtghn\n"
#define MESSAGE_2 "loiu7y6trdcm vali6t\n"
...
int main(void)
{
    ...
    if (childpid1 && childpid2)
    {
        int stat_loc;
        pid_t childpid;
        char mes1[MAX_LEN] = "\0", mes2[MAX_LEN] = "\0";

        printf("Press \"CTRL+Z\" to sent messages.\n\n");
        sleep(5);
