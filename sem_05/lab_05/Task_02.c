...
struct sembuf start_writer[6] = {{WAITING_WRITERS,   1, 0}, {BIN_SEM, -1, 0}, {ACTIVE_READERS,    0, 0}, {ACTIVE_WRITER,     0, 0},
{ACTIVE_WRITER,     1, 0}, {WAITING_WRITERS,  -1, 0}};

struct sembuf stop_writer[2] = {{BIN_SEM, 1, 0}, {ACTIVE_WRITER, -1, 0}};
...
int main()
{
    ...
    semctl(sem_id, BIN_SEM, SETVAL, 0);
